#!/usr/bin/env python
"""
Package metadata for gencourseai.
"""
import os
import re
import sys
...
VERSION = get_version('gencourseai', '__init__.py')
...
setup(
    ...
    author='sanjib basak',
    author_email='sanjib.basak2006@gmail.com',
    url='https://github.com/openedx/gencourseai',
    packages=find_packages(
        include=['gencourseai', 'gencourseai.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        'xblock.v1': [
            'gencourseai = gencourseai:gencourseai_xblock',
        ]
    },
    package_data=package_data("gencourseai", ["static", "public"]),
