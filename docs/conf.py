...
"""
gencourseai documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'gencourseai',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/openedx/gencourseai",
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'generate course',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'gencourseai'),
                os.path.join(root_path, 'gencourseai/migrations')])
